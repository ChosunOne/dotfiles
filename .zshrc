...
plugins=(git direnv poetry ripgrep rust ufw archlinux zsh-autosuggestions)
...
eval "`fnm env`"
export PATH="/home/chosunone/.local/bin:$PATH"
export GPG_TTY=$(tty)
...
[ -f "/home/chosunone/.ghcup/env" ] && source "/home/chosunone/.ghcup/env" # ghcup-env
